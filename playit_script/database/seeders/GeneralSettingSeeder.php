    ...
    public function run()
    {
        DB::table('settings')->insert([
            [
                ...
                'site_description' => 'PLAYIT - Movies & Series Streaming Laravel PHP Script is a complete & outstanding movie streaming solution build on a powerful laravel 8 framework. It auto fetches data from TMDB with API.',
                'site_keywords' => 'PLAYIT,play it,movies,series,tv shows,episodes,play,stream,netflix,amazon prime,php,laravel,script',
                'site_logo' => 'logo.png',
                'site_favicon' => 'favicon.png',
                'site_items_per_page' => '16',
                'site_licence_key' => '',
                ...
                'site_copyright' => '© 2021 - PLAYIT - All rights reserved',

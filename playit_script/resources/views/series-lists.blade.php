...
<div class="container mx-auto bg-gray-800 items-center justify-center">
    ...
    <div class="container mx-auto p-10 inline-block bg-gray-700 ">
        <h2 class="text-white uppercase text-4xl">Series</h2>
        <h4 class="text-white text-xl pt-1">Latest Series added!</h4>
    </div>
    {{-- End Heading --}}
    ...
    <div class="container mx-auto p-10 inline-block">
        ...
        <div class="flex flex-wrap justify-center">
            @if(count($data) > 0)
                                        ...
                                        <div class="card-content-wrap ">
                                            ...
                                            <div class="card-image-content">
                                                <div class="image-card base-card-image">
                                                    <img alt="{{ $series->name }} ({{ date('Y',strtotime($series->release_date)) }})" title="{{ $series->name }} ({{ date('Y',strtotime($series->release_date)) }})" class="original-image" src="{{ $series->poster }}">
                                                </div>
                                                <div>
                ...
                @endforeach
            @else
                <div class="text-white text-2xl">We Counldn't find any series!</div>
            @endif
        </div>

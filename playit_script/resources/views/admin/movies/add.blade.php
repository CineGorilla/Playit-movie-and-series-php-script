...
<div class="main-content-inner">
	...
	{!! Form::open(['route' => 'save_movie','method'=>'post','enctype' => 'multipart/form-data', 'class' => 'form movie']) !!}
		<div class="columns" style="margin-top : 5px;">
		  	<div class="column is-one-quarter">
		    	<div class="field" id="tmdb">
		    		<label><h4>TMDB ID</h4></label>
				  	<div class="control">
				    	<input class="input is-primary" type="text" name="movie_id"placeholder="TMDB ID" val="">
				  	</div>
				  	<button type="button" class="button is-small is-fullwidth is-primary">Generate</button>
				</div>
				<div class="field image">
	                <img src="{{ asset('public/backend/images/default_poster.jpg') }}" alt="poster image" id="movie_poster">
	                <input type="hidden" name="movie_poster_url" value="">
	            ...
	            <div class="field image">
	                <img src="{{ asset('public/backend/images/default_backdrop.jpg') }}" alt="backdrop image" id="movie_image">
				...
				<div class="field">
		    		<label><h4>Duration (in min)</h4></label>
				  	<div class="control">
					    <input name="movie_duration" class="input is-primary is-fullwidth" type="text" placeholder="Duration">
					</div>
				</div>
				<div class="field">
		    		<label><h4>Quality</h4></label>
				  	<div class="control">
					    <input id="quality" type="text" name="movie_quality" value="" placeholder="Quality.." >
					</div>
				</div>
				<div class="field">
		    		<label><h4>Rating</h4></label>
				  	<div class="control">
					    <input name="movie_rating" class="input is-primary is-fullwidth" type="text" placeholder="Rating">
					</div>
				</div>
				<div class="field">
		    		<label><h4>Release Date (YYYY-MM-DD)</h4></label>
				  	<div class="control">
					    <input name="movie_release_date" class="input is-primary is-fullwidth" type="text" placeholder="Release Date">
					</div>
				</div>
				<div class="field">
		  	...
		  	<div class="column">
		  		<div class="field">
		    		<label><h4>Name</h4></label>
				  	<div class="control">
					    <input name="movie_name" class="input is-primary is-fullwidth" type="text" placeholder="Name" val="">
					</div>
				</div>
				<div class="field">
		    		<label><h4>Tagline</h4></label>
				  	<div class="control">
					    <input name="movie_tagline" class="input is-primary is-fullwidth" type="text" placeholder="tagline..." val="">
					</div>
				</div>
				<div class="field">
		    		<label><h4>Description</h4></label>
					<div class="control">
					    <textarea name="movie_description" class="textarea is-primary is-fullwidth" placeholder="Description"></textarea>
					</div>
				</div>
				<div class="field">
				...
				<div class="field">
		    		<label><h4>Trailer</h4></label>
				  	<div class="control">
					    <input name="movie_trailer" class="input is-primary is-fullwidth" type="text" placeholder="Trailer Url..">
					</div>
				</div>
				...
				<div class="field" id="downloads">
					...
					<div class="control download1">
						<div class="columns">
							...
							<div class="column">
								<input name="movie_download_url[]" class="input is-primary" type="text" placeholder="Download Embed Url..">
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#addDownload").click(function(){
	        ...
	        newDownloadDiv.after().html('<div class="columns"><div class="column is-one-quarter"><input name="movie_download_name[]" class="input is-primary is-one-quarter" type="text" placeholder="Download Name.."></div><div class="column"><input name="movie_download_url[]" class="input is-primary" type="text" placeholder="Download Embed Url.."></div></div>');

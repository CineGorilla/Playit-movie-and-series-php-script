...
{!! Form::model($series, ['route' => ['update_series',$series->id],'method'=>'put','enctype' => 'multipart/form-data', 'class' => 'form series']) !!}
    ...
    <div class="columns" style="margin-top : 5px;">
        <div class="column is-one-quarter">
            <div class="field" id="tmdb">
                ...
                <div class="control">
                    <input class="input is-primary" type="text" name="series_id" placeholder="TMDB ID" value="{{ $series->tmdb_id }}">
                </div>
                <button type="button" class="button is-small is-fullwidth is-primary">Generate</button>
            </div>
            <div class="field image">
                <img src="{{ $series->poster }}" alt="poster image" id="series_poster">
                <input type="hidden" name="series_poster_url" value="{{ $series->poster }}">
            ...
            <div class="field image">
                <img src="{{ $series->backdrop }}" alt="backdrop image" id="series_image">
                <input type="hidden" name="series_image_url" value="{{ $series->backdrop }}">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name="series_duration" value="{{ $series->duration }}" class="input is-primary is-fullwidth" type="text" placeholder="Duration">
                </div>
            </div>
            <div class="field">
                <label><h4>Quality</h4></label>
                <div class="control">
                    <input id="quality" type="text" name="series_quality" placeholder="Quality.." >
                </div>
            </div>
            <div class="field">
                <label><h4>Rating</h4></label>
                <div class="control">
                    <input name="series_rating" class="input is-primary is-fullwidth" type="text" placeholder="Rating" value="{{ $series->rating }}">
                </div>
            </div>
            <div class="field">
                <label><h4>First Release Date</h4><p>(YYYY-MM-DD)</p></label>
                <div class="control">
                    <input name="series_release_date" class="input is-primary is-fullwidth" type="text" placeholder="Release Date" value="{{ $series->release_date }}">
                </div>
            </div>
            <div class="field">
        ...
        <div class="column">
            <div class="field">
                ...
                <div class="control">
                    <input name="series_name" class="input is-primary is-fullwidth" type="text" placeholder="Name" value="{{ $series->name }}">
                </div>
            </div>
            <div class="field">
                <label><h4>Tagline</h4></label>
                <div class="control">
                    <input name="series_tagline" class="input is-primary is-fullwidth" type="text" placeholder="tagline..." value="{{ $series->tagline }}">
                </div>
            </div>
            <div class="field">
                <label><h4>Description</h4></label>
                <div class="control">
                    <textarea name="series_description" class="textarea is-primary is-fullwidth" placeholder="Description">{{ $series->description }}</textarea>
                </div>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name="series_trailer" class="input is-primary is-fullwidth" type="text" placeholder="Trailer Url.." value="{{ $series->trailer }}">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var takenactor = {!! $series->actors->pluck('name') !!}; 
    var takencreator = {!! $series->creators->pluck('name') !!}; 
    var takendirector = {!! $series->directors->pluck('name') !!}; 
